...
public class PlaceCategoryController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Place categories are not found", content = @Content(mediaType = "text/plain"))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Place category is added", content = @Content(mediaType = "text/plain")),
    })
